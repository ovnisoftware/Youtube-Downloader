    ...
    public partial class frmYTDownloader : Form
    {
        ...
        private void btnDownload_Click(object sender, EventArgs e)
        {
            ...
            if(isLinkGood.Item1==true)
            {
                ...
                System.Threading.Thread.Sleep(2000);//simulate time period required for download
                EnableAccessibility();//restore access to interface controls
